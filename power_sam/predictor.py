...
from power_sam.modeling import Sam
...
class SamPredictor:
    ...
    def set_image(
        ...
        return self.set_torch_image(input_image_torch, image.shape[:2], return_feats=return_feats)
    ...
    def set_torch_image(
        ...
        if not return_feats:
          ...
          features = self.model.image_encoder(input_image, out_indices=(2, 3, 4, 5))
