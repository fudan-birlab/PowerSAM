...
def main(args, config):
    ...
    if not config.DISTILL.ENCODER_ONLY:
        ...
        prompt_encoder_weights = torch.load('weights/sam_vit_b_prompt_encoder.pth', map_location='cpu')
        ...
        for param in mask_decoder_t.parameters():
            param.requires_grad = False
        mask_decoder_weights = torch.load('weights/sam_vit_b_mask_decoder.pth', map_location='cpu')
